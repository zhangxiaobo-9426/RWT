...
public class VicinityAdapter2 extends BaseQuickAdapter<PoiInfo, BaseViewHolder> {
    public VicinityAdapter2(int layoutResId) {
        super(layoutResId);
    }
...
//    }
    ...
    protected void convert(@NotNull BaseViewHolder baseViewHolder, PoiInfo poiInfo) {
        baseViewHolder.setText(R.id.vicinity_itrm_2_name, poiInfo.name)
                .setText(R.id.vicinity_itrm_2_addre, poiInfo.direction);
    }
}
